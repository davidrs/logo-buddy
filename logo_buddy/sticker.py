...
def stickerfy_all(starter_logo_path):
    ...
    for fl in fun_logos:
        ...
        cv2.imwrite(op.join(sticker_dir,flname.replace(".png","_sticker.png")), sticker)

if __name__ == "__main__":

    for input_img in glob("input/skip/*jpeg") + glob("input/*png") +  glob("input/skip/*png") + glob("input/*jpeg"):
